// Time Complexity: O(n log n), sorting the cars by position takes O(n log n)
// Space Complexity: O(n), stack size worst case can be size n if all cars don't catch up to one another
